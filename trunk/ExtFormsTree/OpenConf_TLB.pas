...
// *********************************************************************//
  IMetaData = interface(IDispatch)
    ...
    function SaveMDToFile(const path: WideString; FireEvent: WordBool): WordBool; safecall;
    ...
    function TestRefers(ID: Integer; FindAll: WordBool): IMetaDataObjArray; safecall;
...
// *********************************************************************//
  IMetaDataDisp = dispinterface
    ...
    function SaveMDToFile(const path: WideString; FireEvent: WordBool): WordBool; dispid 6;
    ...
    function TestRefers(ID: Integer; FindAll: WordBool): IMetaDataObjArray; dispid 13;
...
// *********************************************************************//
  ITaskDef = interface(IMetaDataObj)
    ...
    property ImmediateDelete: WordBool read Get_ImmediateDelete write Set_ImmediateDelete;
...
// *********************************************************************//
  IMetaDataObjChildsDisp = dispinterface
    ['{5B0CDE51-3BB2-4C60-8AA5-63739FD67873}']
    property item[idx: OleVariant]: IMetaDataObjArray readonly dispid 0; default;
    property Count: Integer readonly dispid 1;
    property Name[idx: OleVariant; Rus: WordBool]: WideString readonly dispid 2;
  end;
...
// *********************************************************************//
  IType1C = interface(IDispatch)
    ...
    property PositiveOnly: WordBool read Get_PositiveOnly write Set_PositiveOnly;
    property NumSeparated: WordBool read Get_NumSeparated write Set_NumSeparated;
  end;
...
// *********************************************************************//
  IMigration = interface(IDispatch)
    ...
    property RuleOfMigration: MigrationRules read Get_RuleOfMigration write Set_RuleOfMigration;
    property AutoRegister: WordBool read Get_AutoRegister write Set_AutoRegister;
    property AdditDBSigns: WideString read Get_AdditDBSigns write Set_AdditDBSigns;
  end;
...
// *********************************************************************//
  IConstants = interface(IDispatch)
    ...
    function Add(const Name: WideString; const Present: WideString): IConstDef; safecall;
...
// *********************************************************************//
  IConstantsDisp = dispinterface
    ...
    function Add(const Name: WideString; const Present: WideString): IConstDef; dispid 3;
...
// *********************************************************************//
  ICfgWindows = interface(IDispatch)
    ...
    procedure Set_PanelVisible(const Caption: WideString; pVal: WordBool); safecall;
    ...
    property PanelVisible[const Caption: WideString]: WordBool read Get_PanelVisible write Set_PanelVisible;
  end;
...
// *********************************************************************//
  ICfgWindowsDisp = dispinterface
    ...
    property NextWnd[const CurrentWnd: ICfgWindow]: ICfgWindow readonly dispid 3;
...
// *********************************************************************//
  ICfgWindow = interface(IDispatch)
    ...
    procedure Move(Left: Integer; Top: Integer; Right: Integer; Bottom: Integer); safecall;
...
// *********************************************************************//
  ICfgWindowDisp = dispinterface
    ...
    procedure Move(Left: Integer; Top: Integer; Right: Integer; Bottom: Integer); dispid 10;
...
// *********************************************************************//
  ICfgDocuments = interface(IDispatch)
    ...
    function DocFromID(ID: Integer; Type_: DocTypes; const path: WideString; const Kind: WideString): ICfgDoc; safecall;
...
// *********************************************************************//
  ICfgDocumentsDisp = dispinterface
    ...
    function DocFromID(ID: Integer; Type_: DocTypes; const path: WideString; const Kind: WideString): ICfgDoc; dispid 2;
...
// *********************************************************************//
  IAllTypedObj = interface(IDispatch)
    ...
    function Get_ChildName(const Parent: WideString; idx: Integer): WideString; safecall;
    ...
    property Count: Integer read Get_Count;
    property ChildsCount[const Parent: WideString]: Integer read Get_ChildsCount;
    property ChildName[const Parent: WideString; idx: Integer]: WideString read Get_ChildName;
    property ObjectCount[const Parent: WideString]: Integer read Get_ObjectCount;
  end;
...
// *********************************************************************//
  IAllTypedObjDisp = dispinterface
    ...
    property ChildName[const Parent: WideString; idx: Integer]: WideString readonly dispid 3;
...
// *********************************************************************//
  ICfgTimer = interface(IDispatch)
    ...
    function SetTimer(Interval: Integer; OneTimeOnly: WordBool): Integer; safecall;
...
// *********************************************************************//
  ICfgTimerDisp = dispinterface
    ...
    function SetTimer(Interval: Integer; OneTimeOnly: WordBool): Integer; dispid 1;
...
// *********************************************************************//
  IMDWindow = interface(IDispatch)
    ...
    procedure DoAction(const PathInTree: WideString; Action: mdActions); safecall;
    function Get_hWnd: Integer; safecall;
...
// *********************************************************************//
  IMDWindowDisp = dispinterface
    ...
    procedure DoAction(const PathInTree: WideString; Action: mdActions); dispid 5;
...
// *********************************************************************//
  IDialogDoc = interface(ICfgDoc)
    ...
    procedure Set_LayerVisible(const Name: WideString; pVal: WordBool); safecall;
    function Get_ActiveLayer: WideString; safecall;
    procedure Set_ActiveLayer(const pVal: WideString); safecall;
    procedure DeleteLayer(const Name: WideString; const CopyControlsTo: WideString); safecall;
    ...
    function Get_ctrlProp(ctrlIdx: Integer; propIdx: CtrlPropsIdx): OleVariant; safecall;
    procedure Set_ctrlProp(ctrlIdx: Integer; propIdx: CtrlPropsIdx; pVal: OleVariant); safecall;
    function Get_formProp(formPropIdx: FormPropsIdx): OleVariant; safecall;
    procedure Set_formProp(formPropIdx: FormPropsIdx; pVal: OleVariant); safecall;
    ...
    property LayerName[idx: Integer]: WideString read Get_LayerName write Set_LayerName;
    property LayerVisible[const Name: WideString]: WordBool read Get_LayerVisible write Set_LayerVisible;
    ...
    property ctrlProp[ctrlIdx: Integer; propIdx: CtrlPropsIdx]: OleVariant read Get_ctrlProp write Set_ctrlProp;
    property formProp[formPropIdx: FormPropsIdx]: OleVariant read Get_formProp write Set_formProp;
    property ctrlType1C[idx: Integer]: IType1C read Get_ctrlType1C write Set_ctrlType1C;
  end;
...
// *********************************************************************//
  IDialogDocDisp = dispinterface
    ...
    procedure DeleteLayer(const Name: WideString; const CopyControlsTo: WideString); dispid 16;
    ...
    property ctrlProp[ctrlIdx: Integer; propIdx: CtrlPropsIdx]: OleVariant dispid 23;
...
// *********************************************************************//
  IConfigurator = interface(IDispatch)
    ...
    procedure Message(const msgLine: WideString; marker: MsgLineMarkers); safecall;
    procedure Status(const text: WideString); safecall;
    function OpenOLEForm(const progID: WideString; const Title: WideString): IDispatch; safecall;
    ...
    procedure LogMessageWrite(EventCategory: EventCategories; const Message: WideString; 
    ...
    property CancelHotKey: WordBool read Get_CancelHotKey write Set_CancelHotKey;
  end;
...
// *********************************************************************//
  IConfiguratorDisp = dispinterface
    ...
    procedure Message(const msgLine: WideString; marker: MsgLineMarkers); dispid 5;
    procedure Status(const text: WideString); dispid 6;
    function OpenOLEForm(const progID: WideString; const Title: WideString): IDispatch; dispid 8;
...
// *********************************************************************//
  ISelfScript = interface(IDispatch)
    ...
    function Get_Name: WideString; safecall;
    procedure AddNamedItem(const Name: WideString; const Object_: IDispatch; AsGlobal: WordBool); safecall;
    property Name: WideString read Get_Name;
  end;
...
// *********************************************************************//
  ISelfScriptDisp = dispinterface
    ...
    procedure AddNamedItem(const Name: WideString; const Object_: IDispatch; AsGlobal: WordBool); dispid 1;
  end;
...
// *********************************************************************//
  IWorkBook = interface(ICfgDoc)
    ...
    property NamePage[idx: OleVariant]: WideString read Get_NamePage write Set_NamePage;
...
// *********************************************************************//
  ITextDoc = interface(ICfgDoc)
    ...
    function Get_Range(StartLine: Integer; StartCol: OleVariant; EndLine: OleVariant; 
                       EndCol: OleVariant): WideString; safecall;
    procedure Set_Range(StartLine: Integer; StartCol: OleVariant; EndLine: OleVariant; 
    ...
    procedure MoveCaret(LineStart: Integer; ColStart: Integer; LineEnd: OleVariant; 
    ...
    property Range[StartLine: Integer; StartCol: OleVariant; EndLine: OleVariant; EndCol: OleVariant]: WideString read Get_Range write Set_Range;
    ...
    property BookMark[LineNum: Integer]: WordBool read Get_BookMark write Set_BookMark;
...
// *********************************************************************//
  ITextDocDisp = dispinterface
    ...
    property Range[StartLine: Integer; StartCol: OleVariant; EndLine: OleVariant; EndCol: OleVariant]: WideString dispid 15;
...
// *********************************************************************//
  ITableDoc = interface(ICfgDoc)
    ...
    function SaveToFile(const FileName: WideString): WordBool; safecall;
    function LoadFromFile(const FileName: WideString): WordBool; safecall;
    function SaveToFileAs(const FileName: WideString; Type_: TableSaveTypes): WordBool; safecall;
  end;
...
// *********************************************************************//
  ITableDocDisp = dispinterface
    ...
    function SaveToFile(const FileName: WideString): WordBool; dispid 8;
    function LoadFromFile(const FileName: WideString): WordBool; dispid 9;
    function SaveToFileAs(const FileName: WideString; Type_: TableSaveTypes): WordBool; dispid 10;
    property type_: DocTypes readonly dispid 0;
    property ID: Integer readonly dispid 1;
    property Kind: WideString readonly dispid 2;
    property path: WideString readonly dispid 3;
...
class function CoConfigurator.CreateRemote(const MachineName: string): IConfigurator;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Configurator) as IConfigurator;
end;
...
class function CoMetaDataObjChilds.CreateRemote(const MachineName: string): IMetaDataObjChilds;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MetaDataObjChilds) as IMetaDataObjChilds;
end;
...
class function CoMetaDataObjProps.CreateRemote(const MachineName: string): IMetaDataObjProps;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MetaDataObjProps) as IMetaDataObjProps;
end;
...
class function CoMetaDataObj.CreateRemote(const MachineName: string): IMetaDataObj;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MetaDataObj) as IMetaDataObj;
end;
...
class function CoMetaDataObjArray.CreateRemote(const MachineName: string): IMetaDataObjArray;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MetaDataObjArray) as IMetaDataObjArray;
end;
...
class function CoSelfScript.CreateRemote(const MachineName: string): ISelfScript;
begin
...
class function CoMetaEnumVal.CreateRemote(const MachineName: string): IMetaEnumVal;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_MetaEnumVal) as IMetaEnumVal;
end;
...
class function CoAllTypedObj.CreateRemote(const MachineName: string): IAllTypedObj;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_AllTypedObj) as IAllTypedObj;
end;
...
class function CoCfgDocuments.CreateRemote(const MachineName: string): ICfgDocuments;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_CfgDocuments) as ICfgDocuments;
end;
...
class function CoCfgWindows.CreateRemote(const MachineName: string): ICfgWindows;
begin
